...
public class ArrayExample3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.equals(return1, ArrayExample3.solution(answers1)));
        System.out.println(Arrays.equals(return2, ArrayExample3.solution(answers2)));
        System.out.println(Arrays.equals(return3, ArrayExample3.solution(answers3)));

        System.out.println(Arrays.equals(return1, ArrayExample3.solution2(answers1)));
        System.out.println(Arrays.equals(return2, ArrayExample3.solution2(answers2)));
        System.out.println(Arrays.equals(return3, ArrayExample3.solution2(answers3)));
    }
}
