...
public class Programmers81303 {
    ...
    public static void main(String[] args) {
        ...
        String result2 = "OOXOXOOO";

        System.out.println(Programmers81303.solution(n1, k1, cmd1).equals(result));
        System.out.println(Programmers81303.solution(n2, k2, cmd2).equals(result2));
    }
}
